...
/*
 * Here we expect two inputs appStyleCell which represents the cell value and the * key which represents the cell's key. We also inject ElementRef and Renderer2
